...
python -m tensor2tensor.data_generators.wikisum.parallel_launch \
  ...
  --log_dir=$BUCKET/logs \
  --setup_command="pip3 install tensor2tensor tensorflow -U -q --user" \
  --command_prefix="python3 -m tensor2tensor.data_generators.wikisum.get_references_commoncrawl --num_tasks=1000 --out_dir=$BUCKET/wiki_references"
